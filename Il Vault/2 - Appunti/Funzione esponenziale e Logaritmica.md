...
#Proposizione 
> [!prp] proprietà dell'esponenziale sui reali
...
#Teorema 
> [!thm] le proprietà della funzione esponenziale
Valgono le seguenti:
>1. $\exp_a(0) = 1$ 
...
#Osservazione 
> [!rmk] l'esponenziale è biiettivo, dunque invertibile.
...
#Teorema 
> [!thm] le proprietà del logaritmo
