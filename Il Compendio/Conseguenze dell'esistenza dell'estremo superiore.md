...
**TEOREMA 1.1.** $\mathbb{N}$ è superiormente illimitato. Ovvero *non è superiormente limitato*.
...
**TEOREMA 3.1.** 
Sia $\varepsilon > 0$ (un numero piccolo); allora $\exists \bar{n} \in \mathbb{N}$ tale che $$0 < \frac{1}{n} < \varepsilon$$ovvero prendendo un numero arbitrariamente piccolo, deve esistere un $\frac{1}{n}$ che sarà ancora più piccolo del numero piccolo scelto.
...
**TEOREMA 4.1.**
Si dice che $\mathbb{Q}$ è *denso* in $\mathbb{R}$; ovvero siano $a, b \in \mathbb{R}$ con $a < b$, allora esiste $q \in \mathbb{Q}$ tale che $$a < q < b$$quindi tra due numeri reali $a, b$ possiamo sempre trovarci un numero razionale in mezzo.
...
Sia $(I_n)_n$ una successione di intervalli *chiusi, limitati, inscatolati e dimezzati*; allora l'intersezione di tutti gli intervalli deve contenere un unico punto $\xi$; $$\exists \xi \in \mathbb{R}: \bigcap_n I_n = \{\xi\}$$
### DIMOSTRAZIONE.
La *forma debole dello stesso teorema* (**TEOREMA 5.1.**) mi dice che $$\bigcap_n I_n = [\alpha, \beta]$$dove $\alpha$ è l'estremo superiore degli *"estremi sinistri"* $a_n$ e $b$ l'estremo inferiore degli *"estremi destri"* $b_n$. 
