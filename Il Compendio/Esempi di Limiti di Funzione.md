...
#Esempio 
> [!ex] Esempio 2.2. (limite della funzione quoziente a zero)
...
#Esempio
> [!ex] Esempio 2.3. (limite della funzione quoziente alla $n$ esima potenza)
...
# 3. Funzione radice
#Esempio 
> [!ex] Esempio 3.1. (funzione radice quadrata)
...
#Esempio 
> [!ex] Esempio 4.1. (limite ad una costante del polinomio)
...
#Esempio 
> [!ex] Esempio 4.2. (limite del polinomio all'infinito)
...
#Teorema 
> [!thm] Teorema 6.2. (l'esponenziale è l'infinito "più grande")
...
#Corollario 
> [!cor] Corollario 6.1. (l'esponenziale decresce il più velocemente) 
...
#Esempio 
> [!ex] Esempio 6.4. (la decrescita del logaritmo viene annullata dall'identità)
