...
# 0. Preambolo
#Osservazione 
> [!oss] Osservazione 0.0. (discorso introduttorio)
...
>
Allora prendo il [piano cartesiano](Coppie%20Ordinate%20e%20Prodotto%20Cartesiano) e considero la *circonferenza unitaria* $\Gamma$: $$\Gamma := \{(x,y) \in \mathbb{R}^2: x^2+y^2=1\}$$
...
#Osservazione 
> [!oss] Osservazione 0.1. (questa definizione è poco rigorosa)
...
#Osservazione 
> [!oss] Osservazione 1.1. (prima considerazione)
...
#Definizione 
> [!def] Definizione 1.1. (seno e coseno)
...
#Proposizione 
> [!prop] Proposizione 2.2. (l'identità fondamentale della trigonometria
...
#Proposizione 
> [!prop] Proposizione 2.3. (seno e coseno sono funzioni periodiche)
...
#Proposizione 
> [!prop] Proposizione 2.4. (seno e coseno sono funzioni pari e dispari)
...
#Proposizione 
> [!prop] Proposizione 2.5. (seno e coseno sono "shiftati" tra di loro)
...
#Proposizione 
> [!prop] Proposizione 2.6. (il coseno è il complemento del seno)
...
#Osservazione 
> [!oss] Osservazione 2.1. (forme di somma e di sottrazione)
...
#Osservazione 
> [!oss] Osservazione 2.2. (formule di prostaferesi)
...
#Osservazione 
> [!oss] Osservazione 3.1. ($\cos$ può diventare biiettiva)
...
#Definizione 
> [!def] Definizione 3.1. (arcocoseno)
...
#Definizione 
> [!def] Definizione 4.2. (arcotangente)
