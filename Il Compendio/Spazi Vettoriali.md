...
#Definizione 
> [!def] Definizione 1.1. (spazio vettoriale sul campo K)
...
#Definizione 
> [!def] Definizione 1.2. (l'elemento neutro di un spazio vettoriale)
...
#Osservazione 
> [!oss] Osservazione 1.1. ($1$ non verrà chiamato come l'elemento neutro)
...
#Proposizione 
> [!prop] Proposizione 1.1. ($V_2$ è un $\mathbb{R}$-spazio vettoriale)
...
#Proposizione 
> [!prop] Proposizione 2.1. (l'unicità di $0$) 
...
#Proposizione 
> [!prop] Proposizione 2.2. ($0 \in \mathbb K$ è l'elemento nullo dello scalamento)
...
#Osservazione 
> [!oss] Osservazione 2.1. (c'è ancora qualcosa da dimostrare)
...
#Proposizione 
> [!prop] Proposizione 2.3. (l'elemento opposto è l'elemento scalato per $-1$)
...
#Osservazione 
> [!oss] Osservazione filosofica (il senso di definire e studiare i spazi vettoriali)
...
#Esempio 
> [!ex] Esempio 3.4. ($\mathcal{F}$, l'insieme delle funzioni reali)
...
#Osservazione 
> [!oss] Osservazione 3.1. (chiarimenti sul comportamento della sommo a dello scalamento)
...
#Osservazione 
> [!oss] Osservazione 3.2. (la "funzione nulla")
