...
#Definizione 
> [!def] Definizione 1.1. (matrice $m \times n$ a coefficienti in $K$)
...
#Definizione 
> [!def] Definizione 1.2. (riga e colonna $i$-esima di una matrice)
...
#Definizione 
> [!def] Definizione 1.3. (l'insieme delle matrici $M_{m,n}(\mathbb K)$)
Dati $m, n \in \mathbb{N}$, ove $m>0, n>0$, denotiamo *l'insieme delle matrici* $m \times n$ a coefficienti in $K$ con $$M_{m,n}(\mathbb{K}) $$

#Osservazione 
> [!oss] Osservazione 1.1. ($M_{m,n}(K)$ diventa un $K$-spazio vettoriale)
 Notiamo che con le operazioni di *somma interna* e di *prodotto per uno scalare* definite in [[Operazioni basilari con matrici]], $$(M_{m,n}(\mathbb{R}), +, \cdot)$$è uno [spazio vettoriale](Spazi%20Vettoriali).
^c6b210
# 2. Famiglie di matrici
## Matrici quadrate
#Definizione 
> [!def] Definizione 2.1. (matrice quadrata di ordine $n$)
...
## Matrici nulle
#Definizione 
> [!def] Definizione 2.2. (matrice nulla)
...
#Definizione 
> [!def] Definizione 2.3. (le matrici triangolari superiori)
...
#Osservazione 
> [!oss] Osservazione 2.2. (preambolo)
...
#Definizione 
> [!def] Definizione 2.4. (matrice simmetrica e antisimmetrica)
...
#Osservazione 
> [!oss] Osservazione 2.5. (preambolo)
...
#Definizione 
> [!def] Definizione 2.5. (matrice identità di ordine $n$)
...
## Matrice inversa
#Osservazione 
> [!oss] Osservazione 2.6. (osservazione sui numeri reali)
...
#Definizione 
> [!def] Definizione 2.6. (matrice inversa)
...
#Proposizione 
> [!prop] Proposizione 2.1. (le proprietà della matrice inversa)
