...
#Definizione 
> [!def] Nozione. (n-upla e matrice colonna $K^n$)
...
#Definizione 
> [!def] Definizione 1.1. (sistema lineare di $m$ equazioni in $n$ incognite a coefficienti in $K$)
...
#Definizione 
> [!def] Definizione 1.2. (incognite, termini noti e coefficienti)
...
#Definizione 
> [!def] Definizione 1.3. (soluzione di un sistema)
...
#Definizione 
> [!def] Definizione 1.4. (sistema omogeneo)
...
> [!def] Definizione 1.6. (forma compatta di un sistema lineare)
...
#Definizione 
> [!def] Definizione 1.7. (sistemi lineari equivalenti)
...
#Osservazione 
> [!oss] Osservazione 1.2. (l'utilità di questa nozione)
...
#Osservazione 
> [!oss] Osservazione 1.4. (i sistemi equivalenti possono avere equazioni diversi)
...
#Osservazione 
> [!oss] Osservazione 2.1. (l'unicità della soluzione)
...
#Osservazione 
> [!oss] Osservazione 2.2. (interpretazione geometrica dei sistemi lineari)
