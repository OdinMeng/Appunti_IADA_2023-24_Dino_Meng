...
#Definizione 
> [!math|{"type":"definition","number":"1.1.","setAsNoteMathLink":false,"title":"Punto di aderenza (o di chiusura)","label":"punto-di-aderenza-o-di-chiusura"}] Definizione 1.1. (Punto di aderenza (o di chiusura)).
...
#Teorema 
> [!math|{"type":"theorem","number":"1.1.","setAsNoteMathLink":false,"title":"Proprietà della chiusura $\\bar{E \\ }$","label":"propriet-della-chiusura-bare--"}] Teorema 1.1. (Proprietà della chiusura $\bar{E \ }$).
...
#Definizione 
> [!math|{"type":"definition","number":"2.1.","setAsNoteMathLink":false,"title":"Punto di accumulazione","label":"punto-di-accumulazione"}] Definizione 2.1. (Punto di accumulazione).
...
#Teorema 
> [!math|{"type":"theorem","number":"2.1.","setAsNoteMathLink":false,"title":"Teorema di caratterizzazione degli punti di accumulazione","label":"teorema-di-caratterizzazione-degli-punti-di-accumulazione"}] Teorema 2.1. (Teorema di caratterizzazione degli punti di accumulazione).
...
$$(x_0-r, x_0+r) \cap E = \{x_1, x_2, \ldots, x_k\}$$Che graficamente (**FIGURA 2.1.**) corrisponde a 
...
> [!math|{"type":"theorem","number":"2.2.","setAsNoteMathLink":false,"title":"Primo teorema di Bolzano-Weierstraß","label":"primo-teorema-di-bolzano-weierstra"}] Teorema 2.2. (Primo teorema di Bolzano-Weierstraß).
