...
#Definizione 
> [!def] Definizione 1.2. (dominio, codominio e legge)
...
#Definizione 
> [!def] Definizione 1.3. (scrittura esplicita di una funzione)
...
#Definizione 
> [!def] Definizione 1.4. (funzione di reale variabile)
...
#Osservazione 
> [!oss] Osservazione 1.1. (la definizione di funzione non dipende solo dalla legge)
...
#Osservazione 
> [!oss] Osservazione 1.2. (esempio di funzione e di non-funzione)
...
#Definizione 
> [!def] Definizione 2.1. (valore immagine di un punto di una funzione)
...
#Definizione 
> [!def] Definizione 2.2. (l'insieme immagine di una funzione)
...
#Osservazione 
> [!oss] Osservazione 2.1. (l'insieme immagine è sempre sottoinsieme del codominio)
...
#Definizione 
> [!def] Definizione 3.1. (funzione suriettiva)
...
#Definizione 
> [!def] Definizione 3.2. (funzione iniettiva)
...
#Definizione 
> [!def] Definizione 6.1. (funzione inversa)
...
#Teorema 
> [!thm] Teorema 6.1. (condizione necessaria e sufficiente per l'esistenza della funzione inversa $f^-1$)
...
#Definizione 
> [!def] Definizione 7.1. (insieme contro / pre - immagine di una funzione)
...
#Definizione 
> [!def] Definizione 8.1. (monotonia di una funzione)
...
#Definizione 
> [!def] Definizione 8.2. (funzione strettamente/non crescente o decrescente)
> In particolare, 
...
#Osservazione 
> [!oss] Osservazione 8.1. (la "corretta" pronuncia del termine)
...
#Definizione 
> [!def] Definizione 9.1. (funzione pari o dispari)
...
#Esempio 
> [!ex] Esempio 9.1. (esempio di funzioni pari o dispari)
...
#Definizione 
> [!def] Definizione 10.1. (funzione periodica)
...
#Esempio 
> [!ex] Esempio 10.1. (le funzioni trigonometriche sono periodiche)
...
#Definizione 
> [!def] Definizione 11.1. (Punto di massimo e minimo assoluto) 
...
#Definizione 
> [!def] Definizione 11.2. (massimo e minimo di una funzione)
...
#Osservazione 
> [!oss] Osservazione 11.1. (ci possono essere più punti di massimo ma solo un massimo)
